...
export default function SiteClock() {
  ...
  return (
    <div className="theme-surface theme-text inline-flex items-center gap-2 rounded-full px-4 py-2 text-sm font-semibold shadow-[0_8px_24px_rgba(15,23,42,0.06)]">
