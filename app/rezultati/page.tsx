      ...
      <main className="space-y-8">
        <section className="rounded-[28px] border border-white/10 bg-slate-950/15 p-6 backdrop-blur-lg md:p-8">
          ...
          <h1 className="mt-3 text-4xl font-bold text-white">
            Архивът ще се появи след първите приключени прогнози.
          </h1>
          <p className="mt-4 max-w-3xl leading-7 text-white/75">
            Demo историята е премахната, за да бъде сайтът подготвен чисто за
            deploy. Когато има реални публикувани прогнози и завършени мачове,
            тук автоматично ще започне да се трупа истински архив с резултати и
            статистика.
          </p>
